...
var zh_style_active = 'color:#050505;'; //当前选择的链接式样  
var zh_style_inactive = 'color:#bbbbbb;'; //非当前选择的链接式样  
...
function zh_tranBody(obj) {
	var o = (typeof (obj) == "object") ? obj.childNodes
	...
	for (var i = 0; i < o.length; i++) {
		...
		if (c.alt != '' && c.alt != null)
			c.alt = c.alt.tran();
		if (c.tagName == "INPUT" && c.value != '' && c.type != 'text'
				&& c.type != 'hidden' && c.type != 'password')
